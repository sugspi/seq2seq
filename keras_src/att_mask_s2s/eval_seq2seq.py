...
data_path = '/gs/hs0/tgh-18IAL/manome/snli_0413_formula.txt'#'/home/8/17IA0973/snli_0122_graph.txt'
m_path = 'models13/'
...
# Save model
model = load_model('/home/8/17IA0973/model13_token.h5')
#model = load_model(m_path + 'elapsed_seq2seq.h5')
m = load_model('/home/8/17IA0973/model13_token.h5')
